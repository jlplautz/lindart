...
```
DEBUG=True
CHAVE_LINDART_CRIPTOGRAFIA_PUBLICA= copiar a chave criptografia do site pagar.me e colar aqui
CHAVE_LINDART_API_PRIVADA=copiar a chave API do site pagar.me e colar aqui
```
...
<b>lindart $ heroku config:set DEBUG=False</b>
```
